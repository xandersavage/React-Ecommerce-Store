		...
		<section className="pt-20 pb-20">
			<div className="container mx-auto px-4">
				...
				<div className="grid items-center grid-cols-1 lg:grid-cols-2 gap-12">
					...
					>
						<figure className="h-[39.5rem] overflow-hidden menu-dropdown-toggle:w-full">
							<img
								className="max-w-max transform transition duration-300
                                            group-hover:scale-110 menu-dropdown-toggle:w-full"
								src={collectionMale}
								alt="car!"
							/>
						</figure>
						...
						>
							...
							<div className="card-actions justify-end">
								<button className="btn btn-primary rounded-none mb-9">
									Shop Men's
								</button>
							</div>
						</div>
